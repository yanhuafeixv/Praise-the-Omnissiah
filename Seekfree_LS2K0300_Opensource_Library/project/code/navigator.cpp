...
// // ==================== 控制参数（根据实际小车调试） ====================
// #define WHEEL_TRACK          0.15f     // 两轮间距（米）
// #define ANGLE_TOLERANCE      3.0f      // 角度到位容差（度）
// #define DISTANCE_TOLERANCE   0.02f     // 距离到位容差（米）

// #define MAX_DUTY             60        // 最大占空比（防止飞车）
// #define SPEED_GAIN           40.0f     // 距离控制比例增益（占空比/米误差）
// #define TURN_GAIN            1.5f      // 角度控制比例增益（占空比/度误差）
// // ===================================================================

...
//-------------------------------------------------------------------------------------------------------------------
zf_device_tft180::zf_device_tft180(void)
{
...
// 备注信息     将屏幕清空成背景颜色
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::clear(void)
{
...
// 备注信息     将屏幕填充成指定颜色
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::full(const uint16 color)
{
    uint16 i,j;
    for(i=0;i<240; i++)
    {
...
// 备注信息     在指定坐标绘制一个像素点
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::draw_point(uint16 x, uint16 y, const uint16 color)
{
...
// 备注信息     在指定两点之间绘制一条直线
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::draw_line (uint16 x_start, uint16 y_start, uint16 x_end, uint16 y_end, const uint16 color)
{
...
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::show_char(uint16 x, uint16 y, const char dat)
{
    uint8 i = 0, j = 0;
    for(i = 0; 8 > i; i ++)
    {
...
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::show_string(uint16 x, uint16 y, const char dat[])
{
    uint16 j = 0;
...
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::show_int(uint16 x, uint16 y, const int32 dat, uint8 num)
{
    int32 dat_temp = dat;
    int32 offset = 1;
...
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::show_uint(uint16 x, uint16 y, const uint32 dat, uint8 num)
{
    uint32 dat_temp = dat;
    int32 offset = 1;
    char data_buffer[12] = {0};
...
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::show_float (uint16 x, uint16 y, const double dat, uint8 num, uint8 pointnum)
{
    double dat_temp = dat;
    double offset = 1.0;
...
//-------------------------------------------------------------------------------------------------------------------
void zf_device_tft180::init(const char *path, uint8 is_reload_driver)
{

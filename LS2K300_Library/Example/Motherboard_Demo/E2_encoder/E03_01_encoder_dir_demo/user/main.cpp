...
// 接入方向编码器连接 1
//      模块管脚             单片机管脚
//      PLUS_1              查看 seekfree_2k0300_coreboard.dts 文件中  默认 GPIO28
//      DIR_1               查看 seekfree_2k0300_coreboard.dts 文件中  默认 GPIO29
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 
// 接入方向编码器连接 2
//      模块管脚             单片机管脚
//      PLUS_2              查看 seekfree_2k0300_coreboard.dts 文件中  默认 GPIO34
//      DIR_2               查看 seekfree_2k0300_coreboard.dts 文件中  默认 GPIO35
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
//
// *************************** 例程测试说明 ***************************
...
// 默认的内核使用正交编码器，如果需要使用方向编码器，请修改设备树文件，将编码器类型修改为方向编码器
// 默认的内核使用正交编码器，如果需要使用方向编码器，请修改设备树文件，将编码器类型修改为方向编码器
// 默认的内核使用正交编码器，如果需要使用方向编码器，请修改设备树文件，将编码器类型修改为方向编码器
...
{
    encoder_left = encoder_dir_1.get_count();
    encoder_right = encoder_dir_2.get_count();

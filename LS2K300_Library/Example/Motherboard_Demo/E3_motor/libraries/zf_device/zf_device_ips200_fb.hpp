...
public:
    ...
    // 返回参数     void
    // 使用示例     ips200.show_gray_image(0, 0, image, UVC_WIDTH, UVC_HEIGHT, UVC_WIDTH, UVC_HEIGHT, 0);
    // 备注信息     用于显示总钻风的图像
    ...
    // 返回参数     void
    // 使用示例     ips200.show_rgb565_image(0, 0, image, UVC_WIDTH, UVC_HEIGHT, UVC_WIDTH, UVC_HEIGHT, 1);
    ...
    // 参数说明     height          显示高度
    // 返回参数     void
    // 使用示例     ips200.displayimage_gray(mt9v03x_image[0], 94, 60);
    // 备注信息     替代原宏定义，修复拼写错误 gary->gray，改为类成员函数
    //-------------------------------------------------------------------------------------------------------------------
    ...
    // 参数说明     height          显示高度
    // 返回参数     void
    // 使用示例     ips200.displayimage_rgb565(scc8660_image[0], 80, 60);
    // 备注信息     替代原宏定义，改为类成员函数
    //-------------------------------------------------------------------------------------------------------------------
